...
* This web app: This project focus most of events or resources board for my community. The board should display some information about the event or resource. This will apply the use of REACT library focusing on using the props and className.
